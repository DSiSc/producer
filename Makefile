...
help:
	@echo 'Management commands for DSiSc/producer:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building producer ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/producer/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/producer/version.BuildDate=${BUILD_DATE}" ./...
